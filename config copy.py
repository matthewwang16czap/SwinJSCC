...
class Config:
    ...
    def _setup_cifar10(self, args):
        ...
        self.train_data_dir = "/home/gexin/datasets/CIFAR10/"
        self.test_data_dir = "/home/gexin/datasets/CIFAR10/"
        self.batch_size = 128
        self.downsample = 2
    ...
    def _setup_div2k(self, args):
        ...
        base_path = "/home/gexin/datasets/DIV2K/"
        self.train_data_dir = [
        ...
        # Testset options
        testset_map = {
            "kodak": ["/home/gexin/datasets/Kodak/"],
            "CLIC21": ["/home/gexin/datasets/clic2021/test/"],
            "ffhq": ["/home/gexin/datasets/ffhq/"],
        }
